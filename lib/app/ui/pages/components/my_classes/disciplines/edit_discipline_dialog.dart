...
Future<void> editDisciplineDialog(
  ...
  TextEditingController longNameController =
      TextEditingController(text: discipline.longName);
  TextEditingController shortNameController =
      TextEditingController(text: discipline.shortName);

  return showDialog(
      context: context,
      builder: (context) {
        bool isRegularDiscipline = discipline.isRegularDiscipline!;
        ...
        validateForm() async {
          if (longNameController.text.isNotEmpty &&
            ...
            await context.read<DisciplineStore>().editDiscipline(
                year: year,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                            alignLabelWithHint: true,
                            labelText: 'Editar Sigla ',
                            hintText: '${discipline.shortName}',
