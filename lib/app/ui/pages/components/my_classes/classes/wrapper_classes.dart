...
class WrapperClasses extends StatefulWidget {
  final Discipline discipline;
  const WrapperClasses({super.key, required this.discipline});

  @override
  State<WrapperClasses> createState() => _WrapperClassesState();
}

class _WrapperClassesState extends State<WrapperClasses> {
  @override
  void initState() {
    super.initState();
