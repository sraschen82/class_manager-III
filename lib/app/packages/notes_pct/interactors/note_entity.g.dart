...
Note _noteDeserialize(
  ...
  final object = Note();
  object.check = reader.readBoolOrNull(offsets[0]);
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  QueryBuilder<Note, Note, QAfterFilterCondition> checkIsNull() {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> checkIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> checkEqualTo(bool? value) {
    return QueryBuilder.apply(this, (query) {
